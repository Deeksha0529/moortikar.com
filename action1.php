...
$payment=$_POST['payment1'];
        $sql = "SELECT * FROM `signup` WHERE name = '$cus'";
  ...
  { $order_id="ORDS".rand(10000,99999999);
    $date=date("d-m-Y");
    $sql="INSERT INTO `checking`(`name`,`ORDER_ID`,`TXNAMOUNT`,`PAYMENT_MODE`,`CURRENCY`,`TXNDATE`)VALUES('$cus','$order_id','$ord.00','COD','INR','$date')";
    $result = mysqli_query($con,$sql);
